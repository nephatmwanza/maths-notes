...
Laguerre & $0,\, \infty$ & $e^{-x}\, \cdot\, e^{\alpha}, \,\hspace{0.2cm} \alpha > -1$.\\
\hline
\end{tabular}
\end{table}
...
Thus for $n = 0, \, 1, \, 2, \, 3, \, 4, \, \cdots$ we have $$P_0(x) = 1, \,\hspace{0.5cm}  P_1(x) = x, \,\hspace{0.5cm} P_2(x) = \frac{3}{2}x^2 - \frac{1}{2}, \,\hspace{0.5cm} P_4(x) = \frac{35}{8}x^4 - \frac{30}{8}x^2 + \frac{3}{8}.$$

...
\begin{solution}
Every part standardises with $Z=\dfrac{X-18}{2.5}$.

\textbf{(a)} $z=\dfrac{15-18}{2.5}=-1.2$, so $P(X<15)=P(Z<-1.2)=0.1151$.
...
\textbf{(d)} $z_1=\dfrac{17-18}{2.5}=-0.4$ and $z_2=\dfrac{21-18}{2.5}=1.2$, so
...
\begin{solution}
Here $X\sim N(200,\,15^2)$ and $Z=\dfrac{X-200}{15}$.

\textbf{(a)} $z=\dfrac{224-200}{15}=1.6$, so
...
\textbf{(c)} $z=\dfrac{230-200}{15}=2.0$, so $P(X>230)=1-0.9772=0.0228$. Out of $1000$ cups
...
\textbf{(c)} $z=\dfrac{650-500}{100}=1.5$, so $P(X>650)=1-0.9332=0.0668$, and of $1000$
students
...
\textbf{(a)} $P(X<700)=0.10$ gives $z=-1.28$, and $z=\dfrac{700-\mu}{70}$, so
...
\textbf{(a)} $z=\dfrac{2.7-3.2}{0.2}=-2.5$, so $P(\overline{X}\leq 2.7)=0.0062$.

\textbf{(b)} $z=\dfrac{3.5-3.2}{0.2}=1.5$, so $P(\overline{X}>3.5)=1-0.9332=0.0668$.

\textbf{(c)} $z=0$ and $z=\dfrac{3.4-3.2}{0.2}=1.0$, so
...
\textbf{(a)} $z=\dfrac{4.4-5}{1/3}=-1.8$ and $z=\dfrac{5.2-5}{1/3}=0.6$, so
...
\begin{solution}
\textbf{(a)} The sample proportion is $\hat{P}=\dfrac{114}{200}=0.57$, and for a proportion
the standard error is $\sqrt{\dfrac{\hat{P}(1-\hat{P})}{n}}$. With $z_{0.02}=2.05$:
...
\begin{solution}
\textbf{(a)} $\hat{P}=\dfrac{24}{100}=0.24$ and $z_{0.005}=2.575$:

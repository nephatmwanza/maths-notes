...
(3.2,1.3)--(5,1.3);
\end{tikzpicture}
\caption{Stem-and-leaf plot of the sit-ups data, which keeps every original value visible.}
\end{figure}
...
\end{tikzpicture}
\caption{The five-number summary: minimum, lower quartile, median, upper quartile, maximum.}
\end{figure}
...
\end{tikzpicture}
\caption{The quartiles divide the ordered data into four equal parts.}
\end{figure}
...
\end{tikzpicture}
\caption{Percentiles divide the ordered data into a hundred equal parts; $P_{25}$, $P_{50}$ and $P_{75}$ are the quartiles.}
\end{figure}
...
(-2,2)node[left]{1};
\end{tikzpicture}
\caption{Strong positive linear correlation.}
\end{figure}
...
(-2,2)node[left]{2};
\end{tikzpicture}
\caption{Strong negative linear correlation.}
\end{figure}
...
(-2,2)node[left]{3};
\end{tikzpicture}
\caption{Weak positive correlation.}
\end{figure}
...
(-2,2)node[left]{4};
\end{tikzpicture}
\caption{Weak negative correlation.}
\end{figure}
...
(3,0.1)node[]{$\ast$};
\end{tikzpicture}
\caption{A curved relationship: the association is strong but not linear, so $r$ would understate it.}
\end{figure}
...
\end{tikzpicture}
\caption{The regression line passes through $(\overline{X},\overline{Y})$.}
\end{figure}
